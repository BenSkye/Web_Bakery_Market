...
import { Row, Col, Input, Button, Card, Avatar, Divider, Modal, Form, Radio, Image, Table, message, Select } from 'antd';
                ...
                <Card>
                    ...
                    <Row justify="center" align="middle" style={{ marginTop: '20px' }}>
                        <Radio.Group onChange={handlePaymentChange} value={paymentMethod}>
                            ...
                            <Radio value="cash">
                                <Avatar
                                    src="https://cdn1.iconfinder.com/data/icons/payment-mode/100/vietnamese_dong-2-512.png"
                                    shape="square"
                                    size={96}  // Adjust size as necessary
                                    style={{ marginRight: '10px' }}
                                />
